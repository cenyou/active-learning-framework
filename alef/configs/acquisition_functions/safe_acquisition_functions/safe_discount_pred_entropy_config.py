...
class BasicSafeDiscountPredEntropyConfig(BaseSafeAcquisitionFunctionConfig):
    safety_thresholds_lower: Union[float, Sequence[float]]
    safety_thresholds_upper: Union[float, Sequence[float]]
    alpha: float = 0.02275
    name: str = "safe_discount_pred_entropy"


class BasicSafeDiscountPredEntropyAllConfig(BaseSafeAcquisitionFunctionConfig):
    safety_thresholds_lower: Union[float, Sequence[float]]
    safety_thresholds_upper: Union[float, Sequence[float]]
    alpha: float = 0.02275
    name: str = "safe_discount_pred_entropy_all"
