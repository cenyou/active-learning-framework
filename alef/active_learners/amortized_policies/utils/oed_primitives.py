...
def prior_sample(name, fn, *args, **kwargs):
    return sample_with_type("prior_sample", name, fn, *args, **kwargs)

def hyper_prior_sample(name, fn, *args, **kwargs):
    return sample_with_type("hyper_prior_sample", name, fn, *args, **kwargs)
